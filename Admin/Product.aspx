...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script>
        /* for desappearing alert message*/
                                                ...
                                                <div class="form-group">
                                                 ...
                                                 <div class="form-group">
                                                    ...
                                                    <div>
                                                        ...
                                                        <asp:DropDownList ID="ddlCategories" runat="server" CssClass="form-cont"
                                                            DataSourceID="SqlDataSource1" DataTextField="Name" DataValueField="CategoryId"
                                                            AppendDataBoundItem="true">
                                                                <asp:ListItem Value="0">Select category</asp:ListItem></asp:DropDownList>
                                                    ...
                                                    <asp:Repeater ID="rProduct" runat="server" OnItemCommand="rProduct_ItemCommand"
                                                        ...
                                                        <ItemTemplate>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <img alt="" width="40" src="<%#Foodie.Utils.GetImageUrl(Eval("ImageUrl")) %>" />
                                                                </td>
                                                                ...
                                                                <td>
                                                                    <asp:LinkButton ID="lnkEdit" Text="Edit" CssClass="badge badge-primary" runat="server"
                                                                        ...
                                                                        CommandName="edit"><i class="ti-pencil"></i>
