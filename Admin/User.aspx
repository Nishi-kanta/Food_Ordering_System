                                                    ...
                                                    <asp:Repeater ID="rUsers" runat="server" Onitemcommand="rUsers_ItemCommand">
                                                        ...
                                                        <ItemTemplate>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <asp:LinkButton ID="lnkDelete" runat="server" Text="Delete" CommandName="delete" CommandArgument='<%# Eval("UserId") %>' 
                                                                        CssClass="badge bg-danger" OnClientClick="return confirm('Do you want to delete this User?')">
                                                                        <i class="ti-trash"></i>
                                                                    </asp:LinkButton>
                                                                </td>
                                                            </tr>
