            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form_container">
                        <img id="userLogin" alt="" src="../Images/login.jpg" height="1000" width="500" class="img-thumbnail" />
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form_container">
                        ...
                        <div>
                            <asp:RequiredFieldValidator ID="rfvPassword" runat="server" Font-Size="Small" ErrorMessage="Password is required" ControlToValidate="txtPassword" ForeColor="Red" Display="Dynamic" SetFocusOnError="true"></asp:RequiredFieldValidator>    
